    ...
    if ret==True:
        ...
        for i in cars:
            ...
            if line_down+20<= i.getY() <= line_up-20:
               ...
               if a >= 0:
                     cv2.putText(frame, "BUS", (i.getX(), i.getY()), font, 1, (0,255,255), 2, cv2.LINE_AA)
               else:
        ...
        cv2.putText(frame, str_up, (10, 40), font, 1, (0, 0, 0), 3)
        cv2.putText(frame, str_down, (10, 90), font, 1, (0, 0, 0), 3)
